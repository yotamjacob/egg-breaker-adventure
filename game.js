...
const DEFAULT_STATE = {
  ...
  teleportsChased: 0, teleportsCaught: 0, warpSurges: 0,
  // Hammer economy
...
function _doStarfall(message, cat) {
  ...
  wrap.style.animation = 'starfall-glow 1.2s ease';
  setTimeout(() => wrap.style.animation = '', 1200);
