...
const CONFIG = {
  ...
  eggTypes: [
    {
      ...
      prizes: { empty:5, gold_s:24, gold_m:18, gold_l:8, star:6, mult:2, feather:7, item:6, hammers:0 },
      desc: 'Can be empty',
    },
    {
      ...
      prizes: { empty:1, gold_s:11, gold_m:20, gold_l:16, star:10, mult:3, feather:7, item:8, hammers:10 },
    ...
    },
    {
      ...
      prizes: { empty:0, gold_s:0, gold_m:18, gold_l:26, star:10, mult:2, feather:6, item:10, hammers:8 },
  ...
  crystalBananasToUnlock: 8,    // cost to unlock a new monkey
