...
const MONKEY_DATA = [
  {
    ...
    stages: [
      ...
      { name: 'Frozen Tundra', eggs: 5, collection: { name: 'Arctic Expedition', items: [
        ...
        ['❄️','Ice Crystal',2,'"Chill out. No really, it\'s freezing."'],
      ...
      { name: 'Volcano Island', eggs: 5, collection: { name: 'Volcanic Treasures', items: [
        ...
        ['🔥','Fire Opal',1,'"Warning: extremely hot take."'],
        ...
        ['🫧','Lava Bubble',3,'"I love gold! The look of it, the taste of it."'],
      ...
      { name: 'Cloud Kingdom', eggs: 7, collection: { name: 'Legendary Treasures', items: [
        ...
        ['🏆','Champion Goblet',3,'"Victory tastes like broken eggshells."'],
  ...
  },
  {
    ...
    stages: [
      ...
      { name: 'Laboratory', eggs: 5, collection: { name: 'Inventions', items: [
        ...
        ['📻','Radio',2,'"Broadcasting live from the workshop."'],
      ...
      { name: 'Underground Railway', eggs: 5, collection: { name: 'Railway Finds', items: [
        ...
        ['📋','Travel Log',2,'"First class? More like ONLY class."'],
      ...
      { name: 'Copper Canyon', eggs: 5, collection: { name: 'Rare Metals', items: [
        ['🧱','Copper Brick',1,'"A penny for your thoughts? Here\'s a brick."'],
        ['🩶','Silver Shard',1,'"Silver medal is just first loser. ...kidding."'],
        ['🔶','Gold Cube',2,'"Do you expect me to talk? No, I expect you to smash."'],
  ...
  },
  {
    ...
    stages: [
      { name: 'Royal Garden', eggs: 3, collection: { name: 'Garden Flowers', items: [
        ['🌹','Rose',1,'"Stop and smell me. I dare you."'],
      ...
      { name: 'Grand Ballroom', eggs: 3, collection: { name: 'Dance Treasures', items: [
        ['💃','Dance Shoes',1,'"These shoes were made for smashing."'],
        ...
        ['🪩','Crystal Ball',2,'"Disco never died. It just went crystal."'],
      ...
      { name: 'Royal Treasury', eggs: 5, collection: { name: 'Crown Jewels', items: [
        ...
        ['💎','Royal Diamond',2,'"Pressure makes diamonds. And broken eggs."'],
        ['🔰','Royal Brooch',2,'"First place in egg smashing."'],
      ...
      { name: 'Dragon\'s Lair', eggs: 5, collection: { name: 'Dragon Hoard', items: [
        ...
        ['🪺','Dragon Nest',2,'"I\'m not greedy, I\'m a collector."'],
  ...
  },
  {
    ...
    stages: [
      { name: 'Launch Pad', eggs: 3, collection: { name: 'Launch Gear', items: [
        ...
        ['🛰️','Satellite',1,'"Orbiting at 17,000 mph. No big deal."'],
      ...
      { name: 'Asteroid Belt', eggs: 4, collection: { name: 'Space Rocks', items: [
        ...
        ['💎','Space Diamond',3,'"Formed in the heart of a dying star. Casual."'],
      ...
      { name: 'Jupiter Station', eggs: 5, collection: { name: 'Gas Giant Wonders', items: [
        ...
        ['💎','Pressure Diamond',3,'"Squeezed by Jupiter itself. Worth it."'],
      ]}},
...
const SHOP_SUPPLIES = [
  ...
  { id: 'fastregen',  name: 'Fast Regen',       emoji: '⚡', desc: 'Hammers regen 2x faster', cost: 15000, currency: 'gold', type: 'upgrade', unique: true },
