// Vercel serverless proxy for verify-play-purchase.
// Routes same-origin from the Android WebView to Supabase server-to-server,
// eliminating CORS failures caused by the missing production origin in the edge function.
